...
The repository and release assets are public. The installer downloads directly
from GitHub Releases and can fall back to an authenticated `gh` CLI when needed.
